    ...
    <div className="container px-1">
      <div className="table-box ">
        <div className=" flex  items-start justify-between px-1">
          <h1 className="text-[22px] font-semibold pb-6 flex items-center gap-3">
            {step === 2 && (
              <IoMdArrowRoundBack
                onClick={() => setStep(1)}
                size={25}
        ...
        {step === 1 ? (
          ...
          >
            ...
            <div className="w-full h-[80%] overflow-auto grid gap-8 p-4 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1 mobile:grid-cols-1 xss:grid-cols-1 mt-3">
              {
                selected === "Monthly" ? <>
                <div
                style={{
                ...
                className="rounded-md px-4 w-full h-full py-3"
              >
                <div className="flex items-center pt-4 justify-start mx-auto w-[80%]">
                  <p className="bg-purple-500 w-[22px] h-[22px] rounded-full flex items-center justify-center bg-opacity-[.4]">
                    <p className="bg-purple-800 w-[15px] h-[15px] rounded-full"></p>
                  </p>
                  <p className="text-[22px] font-semibold px-3 text-purple-800">
                    Basic Plan
                  </p>
                </div>
                <div className=" flex items-center justify-center w-[80%] py-3">
                  <p className="text-[34px] font-bold p-4 pr-0">₹144</p>
                  <p className="p-2 text-[16px] text-[#9d9d9d] pt-3">/ month</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-3 pb-3">
                <p className=" w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> 2TB Additionl Storage</p>
                <p className="w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> Up to 1GB File Size</p>
                <p className="w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> Up to 5 Projects</p>
                </div>
                <div className=" w-full mt-4 flex items-center justify-center">
                <button className=" w-[80%] py-3 rounded-2xl text-green_light hover:bg-green_light hover:text-white text-center border-[3px] border-green_light transition-all duration-300">Get Plan</button>
              ...
              >
                <div className="flex items-center pt-4 justify-start mx-auto w-[80%]">
                  <p className="bg-green_light w-[22px] h-[22px] rounded-full flex items-center justify-center bg-opacity-[.4]">
                    <p className="bg-green_light w-[15px] h-[15px] rounded-full"></p>
                  </p>
                  <p className="text-[22px] font-semibold px-3 text-green_light">
                    Standard Plan
                  </p>
                </div>
                <div className=" flex items-center justify-center w-[80%] py-3">
                  <p className="text-[34px] font-bold p-4 pr-0">₹344</p>
                  <p className="p-2 text-[16px] text-[#9d9d9d] pt-3">/ month</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-3 pb-3">
                <p className=" w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> 2TB Additionl Storage</p>
                ...
                <div className=" w-full mt-4 flex items-center justify-center">
                <button className=" w-[80%] py-3 rounded-2xl hover:text-green_light hover:bg-white bg-green_light text-white text-center border-[3px] border-green_light transition-all duration-300">Get Plan</button>
              ...
              >
                <div className="flex items-center pt-4 justify-start mx-auto w-[80%]">
                  <p className="bg-blue w-[22px] h-[22px] rounded-full flex items-center justify-center bg-opacity-[.4]">
                    <p className="bg-blue w-[15px] h-[15px] rounded-full"></p>
                  </p>
                  <p className="text-[22px] font-semibold px-3 text-blue">
                    Premium Plan
                  </p>
                </div>
                <div className=" flex items-center justify-center w-[80%] py-3">
                  <p className="text-[34px] font-bold p-4 pr-0">₹444</p>
                  <p className="p-2 text-[16px] text-[#9d9d9d] pt-3">/ month</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-3 pb-3">
                <p className=" w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> 2TB Additionl Storage</p>
              ...
              >
                ...
                <div className=" flex items-center justify-center w-[80%] py-3">
                  <p className="text-[34px] font-bold p-4 pr-0">₹444</p>
                  <p className="p-2 text-[16px] text-[#9d9d9d] pt-3">/ year</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-3 pb-3">
                <p className=" w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> 2TB Additionl Storage</p>
                <p className="w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> Up to 1GB File Size</p>
              ...
              >
                ...
                <div className=" flex items-center justify-center w-[80%] py-3">
                  <p className="text-[34px] font-bold p-4 pr-0">₹666</p>
                  <p className="p-2 text-[16px] text-[#9d9d9d] pt-3">/ year</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-3 pb-3">
                <p className=" w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> 2TB Additionl Storage</p>
              ...
              <div
                ...
                className="rounded-md px-4 w-full h-full py-3"
              >
                <div className="flex items-center justify-start mx-auto w-[80%] pt-4">
                  <p className="bg-blue w-[22px] h-[22px] rounded-full flex items-center justify-center bg-opacity-[.4]">
                    <p className="bg-blue w-[15px] h-[15px] rounded-full"></p>
                  </p>
                  <p className="text-[22px] font-semibold px-3 text-blue">
                ...
                <div className=" flex items-center justify-center w-[80%] py-3">
                  <p className="text-[34px] font-bold p-4 pr-0">₹999</p>
                  <p className="p-2 text-[16px] text-[#9d9d9d] pt-3">/ year</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-3 pb-3">
                <p className=" w-[80%] flex items-center gap-3 text-[16px] font-medium"><FaPlus size={20} className="text-yellow-400" /> 2TB Additionl Storage</p>
