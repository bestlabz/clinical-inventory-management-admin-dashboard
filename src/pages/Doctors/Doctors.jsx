    ...
    <div className=" w-full h-full p-3 overflow-auto">
      ...
      >
        <Card
          ...
          textColor="#fff"
        />
        <Card title={TranslateJson.doctors.card.text2} count="24" textColor="#000" />
        <Card title={TranslateJson.doctors.card.text3} count="24" textColor="#000" />
      </div>
      ...
      >
        <div className="table-box-top 2xl:h-[100px] xl:h-[100px] lg:h-[100px] md:h-[20%] sm:h-[20%] xs:h-[40%] xss:h-[40%] mobile:h-[40%]">
          <div className="table-box-top-left">
            <TableHeaderTitle title={TranslateJson.doctors.title} subContent={`100 ${TranslateJson.doctors.subText}`}/>
          </div>
